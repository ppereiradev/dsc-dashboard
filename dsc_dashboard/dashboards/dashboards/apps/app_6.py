...
app = DjangoDash('app_6', suppress_callback_exceptions=True, external_stylesheets=[dbc.themes.UNITED, FONT_AWESOME],  external_scripts=EXTERNAL_SCRIPTS)
#server = app.server
...
@app.callback(Output('app_6', 'children'),[Input('interval-component', 'n_intervals')])
