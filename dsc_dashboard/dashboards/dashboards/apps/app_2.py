...
app = DjangoDash('app_2', suppress_callback_exceptions=True, external_stylesheets=[dbc.themes.UNITED, FONT_AWESOME],  external_scripts=EXTERNAL_SCRIPTS)
#server = app.server
...
def charts(data):
    ...
    """
    # SATISFAÇÃO
    df_satisfacao = data['df-satisfacao-conectividade']
    ...
    df_leadtime_bar = data['df-leadtime-conectividade-bar']
    ...
    df_leadtime_scatter = data['df-leadtime-conectividade-scatter']
...
def server_layout():
    ...
    server_layout = html.Div([html.Div([
            ...
            html.A("Conectividade", href='conectividade', style={ "color": "#ff6353", "text-decoration": "underline"}),
        ...
        html.Div(layout(data), id="app_2", className='mb-3'),
...
@app.callback(Output('app_2', 'children'),[Input('interval-component', 'n_intervals')])
